...
# Revisions to guest list.
print(
    f"{guests[0].title()}, {guests[1].title()}, and {guests[2].title()}, "
      "I have found a bigger dinner table, so I will invite more guests.")
...
# New invitations are sent out.
for guest in guests:
    print(f"{guest.title()}, you are invited to my larger party!")

# Additional code for slices assignment.
